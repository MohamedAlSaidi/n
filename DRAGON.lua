...
if text == 'الاحصائياات' and msa3d(msg) then 
local Namebot = (bot_data:get(bot_id..'Name:Bot') or 'فمبير') 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹𝐒??𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍˼',url="t.me/XxvprxX"}},{{text = 'ᴍʏ ᴜsᴇʀ ❦︎',url="t.me/XxlllllllllllllllllllllllllllxX"}},
