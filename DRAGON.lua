...
send(msg.chat_id_, msg.id_,' 🦅لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 🦅اشترك هنا [هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
...
local keyboard = {
{'تنظیف الجروبات','تنظیف المشتركين'},
{'مسح قائمه العام'},
{'العوده'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
...
if text == 'جلب الثانوين' or text == 'جلب الثانوين' then 
...
if text == 'رفع الاساسين' or text == 'رفع الثانوين' then 
function by_reply(extra, result, success)    
if result.content_.document_ then  
local ID_FILE = result.content_.document_.document_.persistent_id_  
local File_Name = result.content_.document_.file_name_ 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sezr_su/17&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹S E Z E R˼', url="t.me/s_e_z_r0"},{text = '˹V A M P I R E˼', url="t.me/XxlllllllllllllllllllllllllllxX"}},
...
if text == 'شادو' or text == 'مبرمج السورس' or text == 'المبرمج شادو' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
Reply_Status(msg,result.id_,"reply","🦅 تم ترقيته مطور ثانوي البوت")  
else
...
Reply_Status(msg,result.sender_user_id_,"reply","🦅 تم تنزيله من الثانوين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","🦅 تم تنزيله من الثانوين")  
else
send(msg.chat_id_, msg.id_,"🦅 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","🦅 تم تنزيله من الثانوين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[رتبتك المبرمج شادو🥺🤍](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
{
{text = '𓆩𝑭𝑨𝑺𝑻𝑬𝑹𓆪', url="t.me/sopowerb0t"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{{text = 'S E Z E R',url="t.me/s_e_z_r0"},{text = 'V A M P I R E', url="t.me/XxlllllllllllllllllllllllllllxX"}},
{{text = '˹ T A W O S L ˼ ',url="t.me/USDDBOT"}}, 
