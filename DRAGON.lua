...
local Namebot = (bot_data:get(ban_id..'Name:Bot') or 'فمبير') 
local DRAGON_Msg = { 
...
print("it is Bot")
N = (bot_data:get(ban_id.."Name:Bot") or "فمبير")
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/XxvprxX/31&caption='  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'فمبير').."" then  
Namebot = (bot_data:get(ban_id..'Name:Bot') or 'فمبير')
local DRAGON_Msg = {
'ااي يبنلوتكه 💕',
...
--------------
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'فمبير').." غادر" or text == 'غادر' and Sudo(msg) then     
...
local Name_Bot = (bot_data:get(ban_id..'Name:Bot') or 'فمبير')
